...
from utils.database import (
    load_documents_metadata, save_documents_metadata,
    load_feedback, save_feedback,
    load_search_history, save_search_history,
...
from utils.pinecone_client import initialize_pinecone
...
async def startup_db_client():
    try:
        app.state.pinecone_index = initialize_pinecone()
...
# Helper functions
# Removed helper functions as they are now in utils/database.py
